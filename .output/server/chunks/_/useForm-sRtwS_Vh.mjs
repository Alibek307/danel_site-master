  ...
  return /* @__PURE__ */ jsx(
    "input",
    {
      ...
      className: cn(
        ...
        "[&:-webkit-autofill]:shadow-[0_0_0_1000px_var(--background)_inset]",
        "[&:-webkit-autofill]:[-webkit-text-fill-color:var(--foreground)]",
        "[&:-webkit-autofill:hover]:shadow-[0_0_0_1000px_var(--background)_inset]",
        "[&:-webkit-autofill:focus]:shadow-[0_0_0_1000px_var(--background)_inset]",
        "dark:[&:-webkit-autofill]:shadow-[0_0_0_1000px_var(--background)_inset]",
        className
      ),
      ...props
    }
...
export { Input as I, Label as L, useForm as u };
//# sourceMappingURL=useForm-sRtwS_Vh.mjs.map
