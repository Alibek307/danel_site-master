        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsx(
            form.Field,
            {
              name: "name",
              validators: {
                onChange: ({ value }) => !value ? "\u0418\u043C\u044F \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E" : value.length < 2 ? "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0434\u043E\u043B\u0436\u043D\u043E \u0441\u043E\u0434\u0435\u0440\u0436\u0430\u0442\u044C \u043C\u0438\u043D\u0438\u043C\u0443\u043C 2 \u0441\u0438\u043C\u0432\u043E\u043B\u0430" : void 0
              },
          ...
          /* @__PURE__ */ jsx(
            form.Field,
            {
              name: "phone",
              validators: {
                onChange: ({ value }) => !value ? "\u0422\u0435\u043B\u0435\u0444\u043E\u043D \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u0435\u043D" : void 0
              },
              children: (field) => /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: field.name, children: "\u0422\u0435\u043B\u0435\u0444\u043E\u043D" }),
                /* @__PURE__ */ jsx(
                  Input,
                  {
                    id: field.name,
          ...
          /* @__PURE__ */ jsx(
            form.Field,
            {
              name: "password",
              validators: {
                onChange: ({ value }) => !value ? "\u041F\u0430\u0440\u043E\u043B\u044C \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u0435\u043D" : value.length < 8 ? "\u041F\u0430\u0440\u043E\u043B\u044C \u0434\u043E\u043B\u0436\u0435\u043D \u0441\u043E\u0434\u0435\u0440\u0436\u0430\u0442\u044C \u043C\u0438\u043D\u0438\u043C\u0443\u043C 8 \u0441\u0438\u043C\u0432\u043E\u043B\u043E\u0432" : void 0
              },
              children: (field) => /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsx(
            form.Field,
            {
              ...
              validators: {
                onChange: ({ value }) => !value ? "\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u0435 \u043F\u0430\u0440\u043E\u043B\u044C" : void 0
              },
              children: (field) => /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: field.name, children: "\u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u0435 \u043F\u0430\u0440\u043E\u043B\u044C" }),
                /* @__PURE__ */ jsx(
                  Input,
                  {
                    id: field.name,
          ...
          /* @__PURE__ */ jsx(
            form.Field,
            {
              name: "address",
              validators: {
                onChange: ({ value }) => !value ? "\u0410\u0434\u0440\u0435\u0441 \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u0435\u043D" : void 0
              },
              children: (field) => /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: field.name, children: "\u0410\u0434\u0440\u0435\u0441" }),
                /* @__PURE__ */ jsx(
                  Input,
                  {
                    id: field.name,
          ...
          form.Subscribe,
          {
            ...
            children: ([canSubmit, isSubmitting]) => /* @__PURE__ */ jsx(
              Button,
              {
                ...
                className: "w-full",
                size: "lg",
                children: isLoading ? "\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0446\u0438\u044F..." : "\u0417\u0430\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u043E\u0432\u0430\u0442\u044C\u0441\u044F"
              }
            )
          }
        ),
...
const SplitComponent = function RegisterPage() {
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-background", children: /* @__PURE__ */ jsx("div", { className: "max-w-md w-full mx-4", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044F" }),
      /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-2", children: "\u0421\u043E\u0437\u0434\u0430\u0439\u0442\u0435 \u0430\u043A\u043A\u0430\u0443\u043D\u0442 \u0434\u043B\u044F \u043E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u044F \u0437\u0430\u043A\u0430\u0437\u043E\u0432" })
    ] }),
    /* @__PURE__ */ jsx(RegistrationFrom, {})
  ] }) }) });
};
